...
import com.rlm.imeikotlin.data.local.dao.OpcionEstudioDao
...
@Inject
constructor(private val opcionEstudioDao: OpcionEstudioDao,
    ...
    val loadAllOptions = resultLiveData(
        databaseQuery = { opcionEstudioDao.getAll() },
        networkCall = { imeiRemoteDataSource.fetchDataGetOptions() },
        saveCallResult = { opcionEstudioDao.saveAll(createOpcionEstudioEntity(it)) })

    private fun createOpcionEstudioEntity(opcionesResponse: OpcionesResponse): List<OpcionEstudioEntity> {
