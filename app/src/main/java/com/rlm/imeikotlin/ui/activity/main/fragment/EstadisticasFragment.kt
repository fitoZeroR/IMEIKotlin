...
class EstadisticasFragment constructor(pagos: List<Pagos>, plan: List<Plan>) : Fragment() {
    companion object {
        fun newInstance(pagos: List<Pagos>, plan: List<Plan>): EstadisticasFragment {
            return EstadisticasFragment(pagos, plan)
        }
    }
}*/
class EstadisticasFragment : Fragment() {
    ...
    companion object {
        ...
        /*fun newInstance(pagos: List<Pagos>, plan: List<Plan>) = EstadisticasFragment().apply {
        ...
        /*fun newInstance(pagos: List<Pagos>, plan: List<Plan>): EstadisticasFragment {
            ...
            estadisticasFragment.arguments = bundle
